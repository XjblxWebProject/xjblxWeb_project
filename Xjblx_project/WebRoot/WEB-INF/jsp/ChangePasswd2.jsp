...
<html>
	...
	<body>
	<form action="${pageContext.request.contextPath }/changePasswordCheck2.action" method="post">
		<div id="banner">
		...
		<div id="message">
			<div id="table_message" >
				<table border="0" cellspacing="25" cellpadding="">
					<tr>
						<td>用户名：</td>
						<td  style="color: red;"><input type="text" name="username" id="userShouName" value="" />*</td>
